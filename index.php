...
<title>星沙龙移动商务平台 by:Marking</title>
</head>
...
<nav class="navbar navbar-default" role="navigation">
   <div class="navbar-header">
      <a class="navbar-brand">星沙龙移动商务平台会员信息采集</a>
   </div>
</nav>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" 
   ...
   <div class="modal-dialog">
      <div class="modal-content">
		 ...
		 <input type="text" class="form-control" id="login" placeholder="请输入星沙龙账号" value=""><br>
		 <input type="text" class="form-control" id="passwd" placeholder="请输入星沙龙账号密码" value=""><br>
